...
const testCases = [
	...
	{
		name: "nested object path, $lt number",
		query: { "foo.bar": { $lt: 1 } },
		input: [
			{ foo: { bar: 0 } },
			{ foo: { bar: 1 } },
	...
	{
		name: "nested object path, $lt str",
		query: { "foo.bar": { $lt: "baj" } },
		input: [
			{ foo: { bar: 0 } },
			{ foo: { bar: 1 } },
			{ foo: { bar: 2 } },
		...
		expected: [{ foo: { bar: "baa" } }],
	},
	{
		name: "nested object path, $lt None",
		query: { "foo.bar": { $lt: null } },
		input: [
			{ foo: { bar: {} } },
			{ foo: { bar: [] } },
			{ foo: { bar: -1 } },
	...
	{
		name: "intermediate indexed array, $lt number",
		query: { "foo.1.bar": { $lt: 1 } },
		input: [
			{ foo: [{}, { bar: 0 }] },
			{ foo: [{ bar: 2 }, {}] },
			{},
